// ======================================================================
// Seq.v generated from TopDesign.cysch
// 06/26/2019 at 15:17
...
// WaveDAC8_v2_10(Clock_SRC=0, DAC_Range=1, DacModeReplString=VDAC8, Sample_Clock_Freq=100000, Wave1_Amplitude=4.08, Wave1_Data=128u,167u,202u,231u,249u,255u,249u,231u,202u,167u,128u,88u,53u,24u,6u,0u,6u,24u,53u,88u, Wave1_DCOffset=2.04, Wave1_Length=20, Wave1_PhaseShift=0, Wave1_Type=0, Wave2_Amplitude=4, Wave2_Data=128u,166u,201u,229u,246u,252u,246u,229u,201u,166u,128u,89u,54u,26u,9u,3u,9u,26u,54u,89u, Wave2_DCOffset=2.04, Wave2_Length=20, Wave2_PhaseShift=0, Wave2_Type=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=WaveDAC8_v2_10, CY_CONFIG_TITLE=WaveDAC8_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveDAC8_1, CY_INSTANCE_SHORT_NAME=WaveDAC8_1, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=WaveDAC8_1, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=3, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=500, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=1000, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_1, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_1, CY_INSTANCE_SHORT_NAME=PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=PWM_1, )
module PWM_v3_30_4 (
    reset,
    clock,
    tc,
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=1, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_LongitudNota, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_LongitudNota, CY_INSTANCE_SHORT_NAME=ADC_LongitudNota, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_LongitudNota, )
module ADC_SAR_v3_10_5 (
	...
	cy_clock_v1_0
		#(.id("5a113e1f-1a3c-4847-9cd5-573d1bbf30c9/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("07f24c64-02d5-491a-ad38-2fe68daba897"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_clock_v1_0
		#(.id("60600fc4-7851-4abb-b0ae-11806fa3058b"),
    ...
    assign Net_775 = ~Net_268;


    assign Net_665 = Net_1371 & Net_775 & Net_364;
    ...
    begin : mux_1
        reg  tmp__mux_1_reg;
        always @(Net_1353 or Net_285 or Net_286 or Net_287 or Net_289)
        begin
            case (Net_289[1:0])
                2'b00 :  tmp__mux_1_reg = Net_1353;
                2'b01 :  tmp__mux_1_reg = Net_285;
                2'b10 :  tmp__mux_1_reg = Net_286;
                2'b11 :  tmp__mux_1_reg = Net_287;
            endcase
        end
        assign Net_1371 = tmp__mux_1_reg;
    end
    // -- Mux end --


	cy_clock_v1_0
		#(.id("c725e2e4-d04a-45e8-a686-971fd2d7c4db"),
		  .source_clock_id("39D5E4C2-EBFC-44ab-AE3D-19F9BBFD674D"),
		  .divisor(1364),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("68dab947-939d-4399-92f9-b27b40d68ec7"),
		  .source_clock_id("39D5E4C2-EBFC-44ab-AE3D-19F9BBFD674D"),
		  .divisor(1147),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("ddd6645b-702b-4062-b793-4775fe49c24b"),
		  .source_clock_id("39D5E4C2-EBFC-44ab-AE3D-19F9BBFD674D"),
		  .divisor(1364),
		  .period("0"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("8fe2c2e6-8c12-4988-b96a-e70ba9fff966"),
    ...
    ADC_SAR_v3_10_5 ADC_LongitudNota (
        .vplus(Net_855),
        .vminus(Net_28),
        .soc(1'b0),
        .eoc(Net_30),
	...
	wire [0:0] tmpOE__Entrada_Potenciometro_net;
	wire [0:0] tmpFB_0__Entrada_Potenciometro_net;
	wire [0:0] tmpIO_0__Entrada_Potenciometro_net;
	wire [0:0] tmpINTERRUPT_0__Entrada_Potenciometro_net;
	electrical [0:0] tmpSIOVREF__Entrada_Potenciometro_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Entrada_Potenciometro
		 (.oe(tmpOE__Entrada_Potenciometro_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Entrada_Potenciometro_net[0:0]}),
		  .analog({Net_855}),
		  .io({tmpIO_0__Entrada_Potenciometro_net[0:0]}),
		  .siovref(tmpSIOVREF__Entrada_Potenciometro_net),
		  .interrupt({tmpINTERRUPT_0__Entrada_Potenciometro_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Entrada_Potenciometro_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
