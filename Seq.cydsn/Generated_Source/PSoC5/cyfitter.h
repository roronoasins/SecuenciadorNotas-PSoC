...
#define Timer1_TimerUDB_rstSts_stsreg__16BIT_STATUS_AUX_CTL_REG CYREG_B1_UDB10_11_ACTL
#define Timer1_TimerUDB_rstSts_stsreg__16BIT_STATUS_REG CYREG_B1_UDB10_11_ST
...
#define Timer1_TimerUDB_rstSts_stsreg__MASK_REG CYREG_B1_UDB10_MSK
#define Timer1_TimerUDB_rstSts_stsreg__MASK_ST_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
#define Timer1_TimerUDB_rstSts_stsreg__PER_ST_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
#define Timer1_TimerUDB_rstSts_stsreg__STATUS_AUX_CTL_REG CYREG_B1_UDB10_ACTL
#define Timer1_TimerUDB_rstSts_stsreg__STATUS_CNT_REG CYREG_B1_UDB10_ST_CTL
#define Timer1_TimerUDB_rstSts_stsreg__STATUS_CONTROL_REG CYREG_B1_UDB10_ST_CTL
#define Timer1_TimerUDB_rstSts_stsreg__STATUS_REG CYREG_B1_UDB10_ST
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_AUX_CTL_REG CYREG_B1_UDB10_11_ACTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_CONTROL_REG CYREG_B1_UDB10_11_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_CONTROL_COUNT_REG CYREG_B1_UDB10_11_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_COUNT_CONTROL_REG CYREG_B1_UDB10_11_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_COUNT_COUNT_REG CYREG_B1_UDB10_11_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_MASK_MASK_REG CYREG_B1_UDB10_11_MSK
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_MASK_PERIOD_REG CYREG_B1_UDB10_11_MSK
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_PERIOD_MASK_REG CYREG_B1_UDB10_11_MSK
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__16BIT_PERIOD_PERIOD_REG CYREG_B1_UDB10_11_MSK
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__7__MASK 0x80u
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__7__POS 7
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_AUX_CTL_REG CYREG_B1_UDB10_ACTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_REG CYREG_B1_UDB10_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__CONTROL_ST_REG CYREG_B1_UDB10_ST_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__COUNT_REG CYREG_B1_UDB10_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__COUNT_ST_REG CYREG_B1_UDB10_ST_CTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__MASK 0x80u
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__MASK_CTL_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__PER_CTL_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
#define Timer1_TimerUDB_sCTRLReg_SyncCtl_ctrlreg__PERIOD_REG CYREG_B1_UDB10_MSK
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_A0_REG CYREG_B1_UDB10_11_A0
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_A1_REG CYREG_B1_UDB10_11_A1
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_D0_REG CYREG_B1_UDB10_11_D0
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_D1_REG CYREG_B1_UDB10_11_D1
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_DP_AUX_CTL_REG CYREG_B1_UDB10_11_ACTL
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_F0_REG CYREG_B1_UDB10_11_F0
#define Timer1_TimerUDB_sT8_timerdp_u0__16BIT_F1_REG CYREG_B1_UDB10_11_F1
#define Timer1_TimerUDB_sT8_timerdp_u0__A0_A1_REG CYREG_B1_UDB10_A0_A1
#define Timer1_TimerUDB_sT8_timerdp_u0__A0_REG CYREG_B1_UDB10_A0
#define Timer1_TimerUDB_sT8_timerdp_u0__A1_REG CYREG_B1_UDB10_A1
#define Timer1_TimerUDB_sT8_timerdp_u0__D0_D1_REG CYREG_B1_UDB10_D0_D1
#define Timer1_TimerUDB_sT8_timerdp_u0__D0_REG CYREG_B1_UDB10_D0
#define Timer1_TimerUDB_sT8_timerdp_u0__D1_REG CYREG_B1_UDB10_D1
#define Timer1_TimerUDB_sT8_timerdp_u0__DP_AUX_CTL_REG CYREG_B1_UDB10_ACTL
#define Timer1_TimerUDB_sT8_timerdp_u0__F0_F1_REG CYREG_B1_UDB10_F0_F1
#define Timer1_TimerUDB_sT8_timerdp_u0__F0_REG CYREG_B1_UDB10_F0
#define Timer1_TimerUDB_sT8_timerdp_u0__F1_REG CYREG_B1_UDB10_F1
#define Timer1_TimerUDB_sT8_timerdp_u0__MSK_DP_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
#define Timer1_TimerUDB_sT8_timerdp_u0__PER_DP_AUX_CTL_REG CYREG_B1_UDB10_MSK_ACTL
...
/* Pin_Led */
#define Pin_Led__0__INTTYPE CYREG_PICU0_INTTYPE2
#define Pin_Led__0__MASK 0x04u
#define Pin_Led__0__PC CYREG_PRT0_PC2
#define Pin_Led__0__PORT 0u
#define Pin_Led__0__SHIFT 2u
#define Pin_Led__AG CYREG_PRT0_AG
#define Pin_Led__AMUX CYREG_PRT0_AMUX
#define Pin_Led__BIE CYREG_PRT0_BIE
#define Pin_Led__BIT_MASK CYREG_PRT0_BIT_MASK
#define Pin_Led__BYP CYREG_PRT0_BYP
#define Pin_Led__CTL CYREG_PRT0_CTL
#define Pin_Led__DM0 CYREG_PRT0_DM0
#define Pin_Led__DM1 CYREG_PRT0_DM1
#define Pin_Led__DM2 CYREG_PRT0_DM2
#define Pin_Led__DR CYREG_PRT0_DR
#define Pin_Led__INP_DIS CYREG_PRT0_INP_DIS
#define Pin_Led__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define Pin_Led__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Pin_Led__LCD_EN CYREG_PRT0_LCD_EN
#define Pin_Led__MASK 0x04u
#define Pin_Led__PORT 0u
#define Pin_Led__PRT CYREG_PRT0_PRT
#define Pin_Led__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Pin_Led__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Pin_Led__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Pin_Led__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Pin_Led__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Pin_Led__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Pin_Led__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Pin_Led__PS CYREG_PRT0_PS
#define Pin_Led__SHIFT 2u
#define Pin_Led__SLW CYREG_PRT0_SLW
...
/* ADC_LongitudNota */
#define ADC_LongitudNota_ADC_SAR__CLK CYREG_SAR1_CLK
#define ADC_LongitudNota_ADC_SAR__CSR0 CYREG_SAR1_CSR0
#define ADC_LongitudNota_ADC_SAR__CSR1 CYREG_SAR1_CSR1
#define ADC_LongitudNota_ADC_SAR__CSR2 CYREG_SAR1_CSR2
#define ADC_LongitudNota_ADC_SAR__CSR3 CYREG_SAR1_CSR3
#define ADC_LongitudNota_ADC_SAR__CSR4 CYREG_SAR1_CSR4
#define ADC_LongitudNota_ADC_SAR__CSR5 CYREG_SAR1_CSR5
#define ADC_LongitudNota_ADC_SAR__CSR6 CYREG_SAR1_CSR6
#define ADC_LongitudNota_ADC_SAR__PM_ACT_CFG CYREG_PM_ACT_CFG11
#define ADC_LongitudNota_ADC_SAR__PM_ACT_MSK 0x02u
#define ADC_LongitudNota_ADC_SAR__PM_STBY_CFG CYREG_PM_STBY_CFG11
#define ADC_LongitudNota_ADC_SAR__PM_STBY_MSK 0x02u
#define ADC_LongitudNota_ADC_SAR__SW0 CYREG_SAR1_SW0
#define ADC_LongitudNota_ADC_SAR__SW2 CYREG_SAR1_SW2
#define ADC_LongitudNota_ADC_SAR__SW3 CYREG_SAR1_SW3
#define ADC_LongitudNota_ADC_SAR__SW4 CYREG_SAR1_SW4
#define ADC_LongitudNota_ADC_SAR__SW6 CYREG_SAR1_SW6
#define ADC_LongitudNota_ADC_SAR__TR0 CYREG_SAR1_TR0
#define ADC_LongitudNota_ADC_SAR__WRK0 CYREG_SAR1_WRK0
#define ADC_LongitudNota_ADC_SAR__WRK1 CYREG_SAR1_WRK1
#define ADC_LongitudNota_IRQ__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define ADC_LongitudNota_IRQ__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define ADC_LongitudNota_IRQ__INTC_MASK 0x01u
#define ADC_LongitudNota_IRQ__INTC_NUMBER 0u
#define ADC_LongitudNota_IRQ__INTC_PRIOR_NUM 7u
#define ADC_LongitudNota_IRQ__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define ADC_LongitudNota_IRQ__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define ADC_LongitudNota_IRQ__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
#define ADC_LongitudNota_theACLK__CFG0 CYREG_CLKDIST_ACFG0_CFG0
#define ADC_LongitudNota_theACLK__CFG1 CYREG_CLKDIST_ACFG0_CFG1
#define ADC_LongitudNota_theACLK__CFG2 CYREG_CLKDIST_ACFG0_CFG2
#define ADC_LongitudNota_theACLK__CFG2_SRC_SEL_MASK 0x07u
#define ADC_LongitudNota_theACLK__CFG3 CYREG_CLKDIST_ACFG0_CFG3
#define ADC_LongitudNota_theACLK__CFG3_PHASE_DLY_MASK 0x0Fu
#define ADC_LongitudNota_theACLK__INDEX 0x00u
#define ADC_LongitudNota_theACLK__PM_ACT_CFG CYREG_PM_ACT_CFG1
#define ADC_LongitudNota_theACLK__PM_ACT_MSK 0x01u
#define ADC_LongitudNota_theACLK__PM_STBY_CFG CYREG_PM_STBY_CFG1
#define ADC_LongitudNota_theACLK__PM_STBY_MSK 0x01u

/* Entrada_Potenciometro */
#define Entrada_Potenciometro__0__INTTYPE CYREG_PICU1_INTTYPE6
#define Entrada_Potenciometro__0__MASK 0x40u
#define Entrada_Potenciometro__0__PC CYREG_PRT1_PC6
#define Entrada_Potenciometro__0__PORT 1u
#define Entrada_Potenciometro__0__SHIFT 6u
#define Entrada_Potenciometro__AG CYREG_PRT1_AG
#define Entrada_Potenciometro__AMUX CYREG_PRT1_AMUX
#define Entrada_Potenciometro__BIE CYREG_PRT1_BIE
#define Entrada_Potenciometro__BIT_MASK CYREG_PRT1_BIT_MASK
#define Entrada_Potenciometro__BYP CYREG_PRT1_BYP
#define Entrada_Potenciometro__CTL CYREG_PRT1_CTL
#define Entrada_Potenciometro__DM0 CYREG_PRT1_DM0
#define Entrada_Potenciometro__DM1 CYREG_PRT1_DM1
#define Entrada_Potenciometro__DM2 CYREG_PRT1_DM2
#define Entrada_Potenciometro__DR CYREG_PRT1_DR
#define Entrada_Potenciometro__INP_DIS CYREG_PRT1_INP_DIS
#define Entrada_Potenciometro__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU1_BASE
#define Entrada_Potenciometro__LCD_COM_SEG CYREG_PRT1_LCD_COM_SEG
#define Entrada_Potenciometro__LCD_EN CYREG_PRT1_LCD_EN
#define Entrada_Potenciometro__MASK 0x40u
#define Entrada_Potenciometro__PORT 1u
#define Entrada_Potenciometro__PRT CYREG_PRT1_PRT
#define Entrada_Potenciometro__PRTDSI__CAPS_SEL CYREG_PRT1_CAPS_SEL
#define Entrada_Potenciometro__PRTDSI__DBL_SYNC_IN CYREG_PRT1_DBL_SYNC_IN
#define Entrada_Potenciometro__PRTDSI__OE_SEL0 CYREG_PRT1_OE_SEL0
#define Entrada_Potenciometro__PRTDSI__OE_SEL1 CYREG_PRT1_OE_SEL1
#define Entrada_Potenciometro__PRTDSI__OUT_SEL0 CYREG_PRT1_OUT_SEL0
#define Entrada_Potenciometro__PRTDSI__OUT_SEL1 CYREG_PRT1_OUT_SEL1
#define Entrada_Potenciometro__PRTDSI__SYNC_OUT CYREG_PRT1_SYNC_OUT
#define Entrada_Potenciometro__PS CYREG_PRT1_PS
#define Entrada_Potenciometro__SHIFT 6u
#define Entrada_Potenciometro__SLW CYREG_PRT1_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Seq"
